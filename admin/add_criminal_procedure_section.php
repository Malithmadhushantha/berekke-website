...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($section_number) || empty($section_name) || empty($section_text)) {
        ...
        $stmt = $pdo->prepare("SELECT id FROM criminal_procedure_code WHERE section_number = ?");
        $stmt->execute([$section_number]);
        if ($stmt->fetch()) {
            $error_message = 'A section with this number already exists.';
        } else {
            try {
                $sql = "INSERT INTO criminal_procedure_code (
                ...
                $success_message = 'Criminal Procedure Code section added successfully!';
...
$page_title = "Add Criminal Procedure Code Section";
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2>
                        ...
                        Add New Criminal Procedure Code Section
                    </h2>
                    <p class="text-muted">Add a new section to the Sri Lankan Criminal Procedure Code database</p>
                </div>
                <div>
                    <a href="admin_index.php" class="btn btn-outline-secondary me-2">
                        <i class="fas fa-arrow-left me-1"></i>Back to Dashboard
                    </a>
                    <a href="manage_criminal_procedure_code.php" class="btn btn-outline-success">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0">
                        ...
                        Criminal Procedure Code Section Details
                    </h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="section_number" name="section_number" 
                                       ...
                                       placeholder="e.g., 154, 155, 200" required>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="form-text">
                                    ...
                                    Enter the complete text of the criminal procedure section including all sub-provisions
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="form-text">
                                    <i class="fas fa-info-circle me-1"></i>
                                    Include any legal amendments, modifications, or updates to this section
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="alert alert-info">
                                    <h6 class="alert-heading">
                                        <i class="fas fa-info-circle me-2"></i>Criminal Procedure Code Guidelines
                                    </h6>
                                    <ul class="mb-0">
                                        <li>Ensure all procedural steps are clearly defined</li>
                                        <li>Include relevant time limits and deadlines</li>
                                        <li>Specify required documentation and forms</li>
                                        <li>Mention applicable court jurisdictions</li>
                                        <li>Reference related sections where necessary</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
