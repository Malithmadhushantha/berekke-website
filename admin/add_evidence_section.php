...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($section_number) || empty($section_name) || empty($section_text)) {
        ...
        $stmt = $pdo->prepare("SELECT id FROM evidence_ordinance WHERE section_number = ?");
        ...
        if ($stmt->fetch()) {
            ...
            try {
                ...
                $success_message = 'Evidence Ordinance section added successfully!';
...
$page_title = "Add Evidence Ordinance Section";
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2>
                        ...
                        Add New Evidence Ordinance Section
                    </h2>
                    <p class="text-muted">Add a new section to the Sri Lankan Evidence Ordinance database</p>
                </div>
                <div>
                    <a href="admin_index.php" class="btn btn-outline-secondary me-2">
                        <i class="fas fa-arrow-left me-1"></i>Back to Dashboard
                    </a>
                    <a href="manage_evidence_ordinance.php" class="btn btn-outline-info">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-info text-white">
                    <h5 class="mb-0">
                        ...
                        Evidence Ordinance Section Details
                    </h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="section_number" name="section_number" 
                                       ...
                                       placeholder="e.g., 5, 17, 32" required>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="form-text">
                                    ...
                                    Enter the complete text of the evidence ordinance section including all provisions for admissibility
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="form-text">
                                    <i class="fas fa-info-circle me-1"></i>
                                    Include any legal amendments, modifications, or updates to this evidence section
                                </div>
                            </div>
                        </div>

                        <!-- Evidence Guidelines Info -->
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="alert alert-info">
                                    <h6 class="alert-heading">
                                        <i class="fas fa-info-circle me-2"></i>Evidence Ordinance Guidelines
                                    </h6>
                                    <ul class="mb-0">
                                        <li>Ensure all evidence rules are clearly stated</li>
                                        <li>Include admissibility conditions and exceptions</li>
                                        <li>Specify burden of proof requirements</li>
                                        <li>Mention procedural requirements for evidence presentation</li>
                                        <li>Reference relevant case law where applicable</li>
                                        <li>Include digital evidence provisions where relevant</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
// Add evidence type helper
document.getElementById('section_topic').addEventListener('focus', function() {
    if (!this.value) {
        const randomType = evidenceTypes[Math.floor(Math.random() * evidenceTypes.length)];
        this.placeholder = `e.g., ${randomType}`;
    }
});
