...
if (!$section_id) {
    header('Location: manage_criminal_procedure_code.php');
    exit();
}

// Fetch section data
try {
    $stmt = $pdo->prepare("SELECT * FROM criminal_procedure_code WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($section_number) || empty($section_name) || empty($section_text)) {
        ...
        $stmt = $pdo->prepare("SELECT id FROM criminal_procedure_code WHERE section_number = ? AND id != ?");
        $stmt->execute([$section_number, $section_id]);
        if ($stmt->fetch()) {
            $error_message = 'A section with this number already exists.';
        } else {
            try {
                $sql = "UPDATE criminal_procedure_code SET 
                ...
                $success_message = 'Criminal Procedure Code section updated successfully!';
...
$page_title = "Edit Criminal Procedure Code Section";
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2>
                        ...
                        Edit Criminal Procedure Code Section
                    </h2>
                    <p class="text-muted">
                ...
                <div>
                    <a href="manage_criminal_procedure_code.php" class="btn btn-outline-secondary me-2">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="manage_criminal_procedure_code.php" class="btn btn-secondary">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete this Criminal Procedure Code section?</p>
            ...
            <div class="modal-footer">
                ...
                <a href="delete_criminal_procedure_section.php?id=<?php echo $section_id; ?>" class="btn btn-danger">
                    <i class="fas fa-trash me-1"></i>Delete Section
                </a>
            </div>
        </div>
...
// Clear change flag on form submit
